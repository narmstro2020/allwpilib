...
TEST(SingleJointedArmTest, Disabled) {
  wpi::sim::SingleJointedArmSim sim(
      wpi::math::Gearbox{wpi::math::DCMotor::kVex775Pro, 2, 300}, 3_kg_sq_m,
...
TEST(SingleJointedArmTest, InitialState) {
  ...
  wpi::sim::SingleJointedArmSim sim(
      wpi::math::Gearbox{wpi::math::DCMotor::kKrakenX60, 2, 125}, 3_kg_sq_m,
