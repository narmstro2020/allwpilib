...
TEST(ElevatorSimTest, StateSpaceSim) {
  frc::sim::ElevatorSim sim(frc::DCMotor::Vex775Pro(4), 8_kg, 0.75_in, 14.67,
...
TEST(ElevatorSimTest, InitialState) {
  ...
  frc::sim::ElevatorSim sim(frc::DCMotor::KrakenX60(2), 8_kg, 0.1_m, 20, 0_m,
...
TEST(ElevatorSimTest, Stability) {
  frc::sim::ElevatorSim sim{
      frc::DCMotor::Vex775Pro(4), 4_kg, 0.5_in, 100, 0_m, 10_m, false, 0_m};
